                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget">
                        ...
                        <ul class="footer-links">
                            ...
                            <li><a href="category.php?id=2"><i class="bi bi-chevron-right"></i> Yoga & Fitness</a></li>
                            ...
                            <li><a href="category.php?id=5"><i class="bi bi-chevron-right"></i> Thực phẩm bổ sung</a></li>
                            <li><a href="category.php?id=6"><i class="bi bi-chevron-right"></i> Quần áo thể thao</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
